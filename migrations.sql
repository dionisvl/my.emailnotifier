...
(
    ...
    confirmed TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'подтвержден ли пользоватем по ссылке из письма',
    FOREIGN KEY (email_id) REFERENCES emails (email_id),
    INDEX confirmed_validts_index (confirmed, validts) USING BTREE
)
